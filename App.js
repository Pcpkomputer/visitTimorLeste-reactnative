                   ...
                   if(route.name==="Discover"){
                        return (
                          <Pressable
                            ...
                            style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                                ...
                                <Text style={{fontSize:EStyleSheet.value('11rem'),color:(isFocused) ? "#d1222c":"#8b8b8b",fontFamily:"QuicksandMedium"}}>Discover</Text>
                          </Pressable>
                        )
                   }
                        ...
                        return (
                          ...
                          style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                              ...
                              <Text style={{fontSize:EStyleSheet.value('11rem'),color:(isFocused) ? "#d1222c":"#8b8b8b",marginTop:EStyleSheet.value('3rem'),fontFamily:"QuicksandMedium"}}>My Trip</Text>
                          </Pressable>
                        )
                   }
                        ...
                        return (
                          ...
                          style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                              ...
                              <Text style={{fontSize:EStyleSheet.value('11rem'),color:(isFocused) ? "#d1222c":"#8b8b8b",marginTop:EStyleSheet.value('3rem'),fontFamily:"QuicksandMedium"}}>Essentials</Text>
                          </Pressable>
                        )
                   }
                        ...
                        return (
                          ...
                          style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                              ...
                              <Text style={{fontSize:EStyleSheet.value('11rem'),color:(isFocused) ? "#d1222c":"#8b8b8b",marginTop:EStyleSheet.value('3rem'),fontFamily:"QuicksandMedium"}}>Search</Text>
                          </Pressable>
                        )
                   }
                        ...
                        return (
                          ...
                          style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                              ...
                              <Text style={{fontSize:EStyleSheet.value('11rem'),color:(isFocused) ? "#d1222c":"#8b8b8b",marginTop:EStyleSheet.value('3rem'),fontFamily:"QuicksandMedium"}}>Profile</Text>
                          </Pressable>
                        )
                   }
                 })
